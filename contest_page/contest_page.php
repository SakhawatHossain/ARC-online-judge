    ...
    <header class="container">
      ...
      <main id="hero" class="main">
        ...
        <section class="contest-section">
          ...
          <div class="contest">
              <h2>Contest Name 1</h2>
              <p>Date: 2024-11-20 | Duration: 2 hours</p>
              <a href="./contest/contest.html"><button class="register-button">Register</button></a>
          </div>
          ...
          <div class="contest">
              <h2>Contest Name 2</h2>
              <p>Date: 2024-11-25 | Duration: 3 hours</p>
          ...
          <div class="contest">
              <h2>Contest Name 3</h2>
              <p>Date: 2024-12-01 | Duration: 1.5 hours</p>
              <button class="register-button">Upsolve</button>
          </div>

          <div class="contest">
            <h2>Contest Name 4</h2>
            <p>Date: 2024-12-01 | Duration: 1.5 hours</p>
            <button class="register-button">Upsolve</button>
        </div>          
      </section>
